...
!(function (t, e) {
                ...
                n(e, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            (n && n.available()) ||
                                N(
                                    "Config module not found, can't set configs values."
                                ),
    ...
    var H = (function (e) {
        ...
        function a() {
            ...
            return (
                l(
                    r((e = o.call.apply(o, [this].concat(i)))),
                    "isDOMLoaded",
                    !1
                ),
                            ...
                            this.document.addEventListener(
                                ...
                                function () {
                                    ("interactive" !== t.document.readyState &&
                                        ...
                                        ((t.isDOMLoaded = !0),
                                        "function" ==
                                            typeof t.waitDomLoadedCallback &&
    ...
    var q = "hook_timer__change_rate",
        F = (function (e) {
            ...
            function a() {
                ...
                t(this, a);
                for (
                    var n = arguments.length, i = new Array(n), u = 0;
                    u < n;
                    u++
                )
                    i[u] = arguments[u];
            ...
            return (
                n(a, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this.setIntervalOrigin =
                                this.getWindow().setInterval),
                                (this.clearIntervalOrigin =
                                    this.getWindow().clearInterval);
                        },
                    },
                    {
                        key: "keptInTime",
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            t.filter(function (t) {
                                ...
                                (e.deactivateModules.includes(n) &&
                                    !t.isCoreModule) ||
                                    e.activateModule(n);
                            });
                        },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            e.length > 0 &&
                                this.launchModules(this.registerModules(e)),
                                (this.getWindow()[M] = 1),
                        ...
                        value: function () {
                            return [
                                ...
                                },
                                {
                                    key: "deactivateModules",
                                    type: f.ARRAY,
                                    values: this.getAllModules().map(function (
                                        t
                                    ) {
                    ...
                    n(e, [
                        {
                            ...
                            value: function (t) {
                                ...
                                e
                                    ? (e.activate(),
                                      P("Module - '".concat(t, "' activated")))
                                    : N(
                                          "Activate module failed, ".concat(
                                              t,
                                              " is not found"
                                          )
                                      );
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                e ||
                                    N(
                                        "Deactivate module failed, '".concat(
                                            t,
                                            "' is not found"
                                        )
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e =
                                    ...
                                    arguments[1];
                                (e && v()) ||
                                    ((this.modules[t.moduleIdentityName] = t),
                                    t.mountHost(this));
                            },
                        },
                        {
    ...
    function pt(t) {
        return Number(
            Math.random().toString().substr(3, t) + Date.now()
        ).toString(36);
    }
    function vt(t) {
        var e = (function () {
                        ...
                        value: function (t) {
                            ...
                            return yt(
                                (e = lt(
                                    ...
                                    "bind",
                                    this
                                )).call.apply(e, [this, t].concat(it(r))),
                                this
                            );
                        },
                    },
                        ...
                        value: function () {
                            ...
                            return this.registerClass(function (e) {
                                var n = (function (t) {
                                    ...
                                    function n() {
                                        return (
                                            z(this, n), e.apply(this, arguments)
                                        );
                                    }
                                    return n;
                                })(e);
        ...
        return (
            (function (t, e) {
                var n =
                    ...
                    r = e.prototype;
                Object.setPrototypeOf(t, r),
                    "function" == typeof r[n] && r[n].call(t);
            ...
            n(a, [
                    ...
                    value: function (t) {
                        ...
                        B(c(a.prototype), "onRateChange", this).call(this, t),
                            ...
                            Object.values(this.interval).forEach(function (t) {
                                (t.args[1] = Math.floor(
                                    (t.originMS || 1) * e.percentage
                                )),
                                    e.clearIntervalOrigin.call(
                                        e.window,
                                        t.nowId
                                    ),
                                    (t.nowId = e.setIntervalOrigin.apply(
                                        e.window,
                                        t.args
                                    ));
                            }),
                            Object.values(this.timeout).forEach(function (t) {
                                ...
                                (t.args[1] = a),
                                    ...
                                    e.clearTimeoutOrigin.call(
                                        e.window,
                                        t.nowId
                                    ),
                                    (t.nowId = e.setTimeoutOrigin.apply(
                                        e.window,
                                        t.args
                                    ));
                            });
                ...
                },
                {
                    ...
                    value: function (t) {
                        var e = t[0];
                        this.interval[e] &&
                            ((t[0] = this.interval[e].nowId),
                            delete this.interval[e]),
                            this.timeout[e] &&
                                ((t[0] = this.timeout[e].nowId),
                                delete this.timeout[e]);
                    },
                },
                {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            this.DateModified &&
                                ...
                                B(c(a.prototype), "onRateChange", this).call(
                                    this,
                                    t
                                );
                        },
                            ...
                            .map(function (t) {
                                return (
                                    ...
                                    n.expressions &&
                                        ...
                                        (n.conditions = n.expressions.map(
                                            function (t) {
                                                return (function (t) {
                                                    var e =
                                                            arguments.length >
            ...
            n(a, [
                {
                    ...
                    value: function () {
                        B(c(a.prototype), "onMounted", this).call(this),
                            ...
                            (this.definePropertyOrigin =
                                this.window.Object.defineProperty);
                    },
                },
                {
                    key: "isCoreModule",
        ...
        return (
            n(o, [
                ...
                },
                {
                    ...
                    value: function (t) {
                        var e = (this.definitionModule || {})
                            .definePropertyOrigin;
            ...
            return (
                n(o, [
                        ...
                        value: function () {
                            ...
                            B(c(o.prototype), "init", this).call(this),
                                "function" == typeof D.registerMenuCommand &&
                                    ...
                                    D.registerMenuCommand(
                                        "打开配置页面",
                                        function () {
                                            t.openPage(
                                                "https://timer.palerock.cn/configuration"
                                            );
                                        }
                                    ));
                        },
                    },
                    {
                        ...
                        value: function () {
                            var t = this;
                            return this.getDeclaredConfigurations().map(
                                function (e) {
            ...
            return (
                n(a, [
                    ...
                    },
                    {
                        key: "displayNum",
                        get: function () {
                            return (this.rate.toString().split(".")[1] || "")
                                .length > 2
                                ? this.rate.toFixed(2)
                                : this.rate.toString();
                        },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            var e = this;
                            return (
                                Object.keys(this.clickMapper).forEach(function (
                                    n
                                ) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.nodeElement ||
                                    (this.nodeElement = this.genElement()),
                                this.nodeElement
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (
                                (B(c(a.prototype), "onUiRateChange", this).call(
                                    this,
                                    t
                                ),
                                this.nodeElement)
                                ...
                                var e =
                                        this.nodeElement.querySelector(
                                            "._th-click-hover"
                                        ) || {},
                                    n =
                                        this.nodeElement.querySelector(
                                ...
                                (o.className = "_th_cover-all-show-times"),
                                    this.setTimeoutOrigin.bind(this.window)(
                                        function () {
                                            o.className =
                                                "_th_cover-all-show-times _th_hidden";
                                        },
